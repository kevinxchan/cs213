...
void fetch() {
  ...
  insOpImm  = mem [pc+1];
  pc += 2;
  static const void* jumpTable[12] = { &&L0, &&DEFAULT, &&DEFAULT, &&DEFAULT, &&DEFAULT, &&DEFAULT, &&DEFAULT,
    &&DEFAULT, &&DEFAULT, &&DEFAULT, &&DEFAULT, &&LB };
...
int exec() {
  int cont = 1;
  int addr, val;
  static const void* jumpTable[16] = { &&L0, &&L1, &&L2, &&L3, &&L4, &&DEFAULT, &&L6, &&L7, &&L8, &&L9, &&LA,
    &&LB, &&LC, &&LD, &&LE, &&LF };
  ...
  L4:
    ...
    goto CONT;
  L6: {
    static const void* jumpTable2[16] = { &&L00, &&L01, &&L02, &&L03, &&L04, &&L05, &&L06, &&L07, &&DEFAULT0, &&DEFAULT0,
      &&DEFAULT0, &&DEFAULT0, &&DEFAULT0, &&DEFAULT0, &&DEFAULT0, &&L0F };
    if (insOp0 < 0 || insOp0 > 0xf) goto DEFAULT0;
